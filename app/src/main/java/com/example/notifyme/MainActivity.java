...
public class MainActivity extends AppCompatActivity {
    private UpdateBroadcastReceiver uReceiver = new UpdateBroadcastReceiver();
    private CancelBroadcastReceiver cReceiver = new CancelBroadcastReceiver();
    ...
    public class UpdateBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action == null || !action.equals(ACTION_UPDATE_NOTIFICATION)) {
                return;
            }
            Log.e("here",">>"+"update");
            updateNotification();
    ...
    public class CancelBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            if (action == null || !action.equals(ACTION_CANCEL_NOTIFICATION)) {
                return;
            }
            Log.e("here",">>"+"cancel");
            cancelNotification();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(uReceiver,new IntentFilter(ACTION_UPDATE_NOTIFICATION));
